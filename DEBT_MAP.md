...
**Pendentes:** G2 (`replay_control.py` monolítico, **ALTA**), X6 (endpoints de captura para sessões grandes, **PARCIAL** — janela+cache+teto de checkpoints entregues em 2026-08-01; falta persistir checkpoints na captura ou cache em disco do payload), X5 (Synthetic ↔ Replay não exposto na API), R6, S2–S4, T1–T2, X2 (severidade baixa/média).
